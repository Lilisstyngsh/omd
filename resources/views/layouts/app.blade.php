                        ...
                        @if (auth()->user()->role === 'omd_leader')
                            <div class="nav-dropdown {{ request()->routeIs('omd.master.*') ? 'open' : '' }}">
                                ...
                                <div class="nav-dropdown-menu">
                                    ...
                                    {{-- PPIC --}}
                                    <a href="{{ route('omd.master.ppic') }}"
                                        class="{{ request()->routeIs('omd.master.ppic') ? 'active' : '' }}">
                                    ...
                                    {{-- Produksi --}}
                                    <a href="{{ route('omd.master.produksi') }}"
                                        class="{{ request()->routeIs('omd.master.produksi') ? 'active' : '' }}">
